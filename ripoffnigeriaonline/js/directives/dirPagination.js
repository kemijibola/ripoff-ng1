...
(function () {
    ...
    app.directive('dirPaginationControls', ['paginationService', 'paginationTemplate', function (paginationService, paginationTemplate) {
    ...
    app.provider('paginationTemplate', function () {

        var templatePath = 'js/directives/dirPagination.tpl.html';
