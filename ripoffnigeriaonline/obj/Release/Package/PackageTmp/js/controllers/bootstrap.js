...
app.controller('MenuHeaderCtrl', ['$scope', '$location', 'infraDataService', 'authService', '$state', 'localStorageService', 'searchService', '$http', function ($scope, $location, infraDataService, authService, $state, localStorageService, searchService, $http) {

    $scope.username = "";
    $scope.user = {};
    $scope.username = authService.authentication.userName;
    $scope.emailActivated = false;
    $scope.isAdmin = false;
    ...
    $http.get('api/accounts/user/' + $scope.username)
       .then(function (result) {
           $scope.user = result.data;
           $scope.userEmail = $scope.user.email;
           $scope.userEmailStatus = $scope.user.emailConfirmed;
           if ($scope.userEmailStatus == true) {
               $scope.emailActivated = true;
           }
           else {
               $scope.emailActivated = false;
           }
    ...
    $scope.toSearchRoute = function () {
        searchService.companyName = $scope.companyName;
        $state.go('app.page.search', { param: searchService.companyName })
    };
